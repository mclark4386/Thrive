    ...
    MACRO(FIND_PATH_HELPER FILENAME DIR SUFFIX USERENDERER)
       ...
       ELSE()
          ...
          IF (${ARGC} GREATER 4)
            message(STATUS "TEST AAAA")
            LIST(APPEND CEGUI_INCLUDE_DIR ${${FILENAME}_DIR})
                message(STATUS "PATH 1")
             message(STATUS ${${FILENAME}_DIR})
                 message(STATUS "PATH2")
          ELSE()
          message(STATUS "TEST BBBB")
          
            LIST(APPEND CEGUI_INCLUDE_DIR ${${FILENAME}_DIR}/../)
          ENDIF()
       ENDIF()
    ENDMACRO()
  message(STATUS "TEST B")
